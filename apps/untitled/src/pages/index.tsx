...
import MarullocEditor from '@/components/TextEditor/MarullocEditor';

const TUITextEditor = dynamic(
    () => import('@/components/TextEditor/TUITextEditor'),
    { ssr: false },
);
    ...
    return (
        <>
            ...
            <div style={{ padding: 10 }}>
                <TUITextEditor content="" editorRef={ref} />
                <MarullocEditor />
            </div>
            ------
